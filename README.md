...
- **Library**: C API via [`include/HYPREDRV.h`](include/HYPREDRV.h) driven by YAML input (file or in-memory) and other [`interfaces/`](interfaces) including C++, Fortran, Python, MATLAB/Octave, and Julia
